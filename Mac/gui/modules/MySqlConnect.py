...
class MySqlConnect:
    ...
    def __init__(self, local_bind_p):
        ...
        self.connection = connect(host='127.0.0.1', port=self.local_bind_p, user='mgrum',
                                  passwd='6pRxeM4P', db='opendarkness', charset='utf8',
                                  use_unicode=True)
    ...
    def get_risikoeinstellung(self, proj_id):
        """
